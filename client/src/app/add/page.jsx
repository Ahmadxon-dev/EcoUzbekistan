...
function Page(props) {
    ...
    useEffect(()=>{
        ...
        if (url){
            fetch(`${process.env.NEXT_PUBLIC_SERVER}/add`, {
                method: "post",
                headers:{
    ...
    return (
        <>
            <form className="space-y-6 max-w-md mx-auto p-6 bg-card rounded-lg shadow">
                ...
                <Button onClick={postImage} disabled={loading && true} type="submit">
                    Qo'shish
